...
class cpp_util::GuidedFilterImpl
{
public:
...
class GuidedFilterMono : public cpp_util::GuidedFilterImpl
{
public:
...
class GuidedFilterColor : public cpp_util::GuidedFilterImpl
{
public:
...
cv::Mat cpp_util::guidedFilter(const cv::Mat &I, const cv::Mat &p, int r, double eps, int depth)
{
	return GuidedFilter(I, r, eps).filter(p, depth);
}


cv::Mat CPPUTIL_DLL_API cpp_util::guidedFilter(const cv::Mat & I, int r, double eps, int depth)
{
	cv::Mat p = I;
	return GuidedFilter(I, r, eps).filter(p, depth);
}
